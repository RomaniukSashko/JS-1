...
const myString = "The whole secret of a successful life is to find out what is one's destiny to do, and then do it";
...
const userWarning = alert("Увага! Дія може бути небезпечною.");
console.log(userWarning);

const userChoise = confirm("Ви впевнені, що хочете продовжити?");
